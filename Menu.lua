...
local function GetQuestMarkerMenu()
  return {
    type = "submenu",
...
local function GetLostTreasureMenu()
  return {
    type = "submenu",
    name = "Lost Treasure",
    controls = {
...
local function GetWaypointMenu()
  return {
    type = "submenu",
...
local function CreateOptionsPanel()
  local Menu = {}
  Menu[1] = GetDisplayMenu()
  Menu[2] = GetCompassMenu()
  Menu[3] = GetGroupMenu()
  Menu[4] = GetQuestMarkerMenu()
  Menu[5] = GetWaypointMenu()
  Menu[5] = GetLostTreasureMenu()
  Menu[6] = GetPOIMenu()
  Menu[7] = GetSkyshardMenu()
  Menu[8] = GetLoreBooksMenu()
  Menu[9] = GetWarning()
  return Menu
end
...
function ProvinatusMenu:Initialize()
  ...
  LAM2:RegisterOptionControls(CrownPointerThing.name .. "Options", CreateOptionsPanel())
