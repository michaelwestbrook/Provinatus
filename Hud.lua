...
local function GetProjectedCoordinates(X1, Y1, X2, Y2, CameraHeading)
  ...
  local DistanceProjected = math.min(math.atan(math.sqrt((DistanceX * DistanceX) + (DistanceY * DistanceY)) / 2.2025071263 * CrownPointerThing.SavedVars.HUD.ZoomLevel), 1) * CrownPointerThing.SavedVars.HUD.Size
