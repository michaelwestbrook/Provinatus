...
function ProvinatusCompass:OnUpdate()
  ...
  for i = 1, 4 do
    ...
    if (IsUnitGrouped("player") or CrownPointerThing.SavedVars.HUD.Compass.AlwaysOn) and (not ZO_ReticleContainer:IsHidden() or Provinatus.PerformingResurrection == true)  then
